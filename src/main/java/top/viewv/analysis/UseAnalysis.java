...
public class UseAnalysis {
	...
	private void addGetColumnAPIs()
	{
		...
		//JDBC
		getColumnAPIs.add("<java.sql.ResultSet: java.lang.String getString(int)>");
		getColumnAPIs.add("<java.sql.ResultSet: int getInt(int)>");
	}
					...
					else
					{
						...
						if(actualNode.containsInvokeExpr())
						{
							try
							{
								...
								if(className.startsWith("java.lang.") || className.equals("android.database.Cursor") || className.equals("java.sql.ResultSet"))
