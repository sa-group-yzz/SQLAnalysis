...
//	private Set<DNode> allDNode = new HashSet<>();
	...
	//return a map mapping a node to the nodes dominate it
	public Map<NodeInterface,Set<NodeInterface>> getDominatorSet()
	{
		return domSet;
	}
	
	//return a map mapping a node to the nodes it dominates
	public Map<NodeInterface,Set<NodeInterface>> getDominatorTable()
	{
		return dTable;
	}
	...
	public Map<NodeInterface,NodeInterface> getImmediateDominator(){
		return immediateDomMap;
	}
