...
import top.viewv.analysis.QueryAnalysis;
...
public class SilicaFinder {
	...
	static {
		...
		//JDBC
		relevantAPIs.add("<java.sql.Statement: boolean execute(java.lang.String)>");
		relevantAPIs.add("<java.sql.ResultSet: java.lang.String getString(int)>");
		relevantAPIs.add("<java.sql.ResultSet: int getInt(int)>");
		relevantAPIs.add("<java.sql.Statement: java.sql.ResultSet executeQuery(java.lang.String)>");
